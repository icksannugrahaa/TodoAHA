...
abstract class SwipeCallback(context: Context) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT or ItemTouchHelper.RIGHT) {
    ...
    private val editColor = ContextCompat.getColor(context, R.color.blue_200)
    private val deleteIcon = R.drawable.ic_delete_white
    private val editIcon = R.drawable.ic_edit_white
